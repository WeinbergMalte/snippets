...
def get_encoder_testframe(which=0):
...
class TestOrdinalTargetEncoding:
    @pytest.fixture
    def encoder(self):
        from mw_utils.encoder import ordinal_target_encoding
    ...
    def test_func(self, encoder, indices, columns):
        ...
        df_list_in = [get_encoder_testframe(i) for i in indices]
